...
\begin{itemize}
	...
	The New York Times had more than 130,000 manual labeled trainings recipes. The CoNLL-task\footnote{\parencite{TjongKimSang2003}}, what is a common reference for CRF tasks, provides more than 10,000 labeled sentences. Building such a huge trainings set is out of scope for this project.
\end{itemize}
