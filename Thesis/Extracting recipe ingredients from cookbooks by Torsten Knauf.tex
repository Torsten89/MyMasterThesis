...
- wenn weitere tags (Links, cooktime, yield, ...) xmlElems (kind, start, end) statt ingsOfSentence = [], linksOfSentence = []..., gleiches mit if else in __getTokensWithExtractedIngs__ (ref Bachelorarbeit, smell)
