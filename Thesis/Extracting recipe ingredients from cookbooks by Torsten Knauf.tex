...
We present a very basic prototype for extracting of ingredients from recipes based on CRF in this chapter. The program uses the python binding of crfsuite\footnote{\url{http://www.chokkan.org/software/crfsuite/}}. The program can be found under the following git tag\footnote{\url{https://github.com/Torsten89/SourceCodeExtractingRecipeIngredientsFromCookbooks/tree/FirstCRFPrototype}}.

- how to teach opt and alt group?
- sowieso nach parsen für zuordnung von quantity, unit und ingredient
